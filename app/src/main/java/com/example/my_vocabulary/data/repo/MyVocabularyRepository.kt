...
class MyVocabularyRepository @Inject constructor(var myVocabularyDataSource: MyVocabularyDataSource) {
    ...
    suspend fun insertVocabulary(id: Int, defaultLanguage: String, translateLanguage: String, text: String, translatedText: String,examples: String) = myVocabularyDataSource.insertVocabulary(id,defaultLanguage,translateLanguage,text,translatedText,examples)
